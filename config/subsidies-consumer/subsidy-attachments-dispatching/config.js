...
const SLEEP_BETWEEN_BATCHES = parseInt(process.env.SLEEP_BETWEEN_BATCHES || 1000); // 1 second
const MAX_FILE_DOWNLOAD_RETRY_ATTEMPTS = parseInt(process.env.MAX_FILE_DOWNLOAD_RETRY_ATTEMPTS || 5);
const SLEEP_TIME_AFTER_FAILED_FILE_DOWNLOAD_OPERATION = parseInt(process.env.SLEEP_TIME_AFTER_FAILED_FILE_DOWNLOAD_OPERATION || 60000); // 1 minute
const SLEEP_TIME_AFTER_FAILED_DB_OPERATION = parseInt(process.env.SLEEP_TIME_AFTER_FAILED_DB_OPERATION || 60000); // 1 minute
